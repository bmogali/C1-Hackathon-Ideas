...
const TRIPS = {
  paris: {
    ...
    budget: 2400, tower: '🗼', airports: 'CDG', welcome: 'Bienvenue à Paris 🇫🇷',
  ...
  nyc: {
    ...
    budget: 1800, tower: '🗽', airports: 'JFK', welcome: 'Welcome to New York 🗽',
...
const tripState = { paris: freshTripState(), nyc: freshTripState() };
...
const RECS = {
  hot: {
    hero: { icon: '🧴', name: 'SPF 50 mineral sunscreen', price: 12, back: 5 },
    kit: [
      { icon: '🕶️', name: 'Polarized sunglasses', why: 'Full-sun afternoons', price: 28, back: 6 },
      { icon: '🧢', name: 'Packable sun hat', why: 'Long queues, little shade', price: 18, back: 4 },
      { icon: '💧', name: 'Insulated water bottle', why: 'Refill, stay cool', price: 24, back: 5 },
    ],
    local: 'Pharmacy sunscreen next to the big sights runs about 3× the price you\'d pay today.',
  },
  cold: {
    hero: { icon: '🧥', name: 'Packable down jacket', price: 119, back: 8 },
    kit: [
      { icon: '🧤', name: 'Thermal touchscreen gloves', why: 'Photos without frostbite', price: 22, back: 6 },
      { icon: '🧣', name: 'Merino wool scarf', why: 'Wind chill below freezing', price: 34, back: 5 },
      { icon: '🥾', name: 'Waterproof snow boots', why: 'Icy sidewalks ahead', price: 89, back: 7 },
    ],
    local: 'Buying winter layers in-city means tourist-district markup — roughly double.',
  },
  rain: {
    hero: { icon: '🧥', name: 'Packable rain shell', price: 59, back: 7 },
    kit: [
      { icon: '☔', name: 'Compact travel umbrella', why: 'Daily showers expected', price: 19, back: 5 },
      { icon: '👟', name: 'Waterproof sneakers', why: 'Wet cobblestones', price: 74, back: 6 },
      { icon: '🎒', name: 'Dry-bag daypack', why: 'Keep the camera dry', price: 39, back: 5 },
    ],
    local: 'Street umbrellas double in price the minute it starts raining. They know.',
  },
  mild: {
    hero: { icon: '🔋', name: '10k mAh power bank', price: 29, back: 6 },
    kit: [
      { icon: '🎒', name: 'Anti-theft daypack', why: 'Busy old-town streets', price: 39, back: 5 },
      { icon: '👟', name: 'Walking sneakers', why: '20k steps a day', price: 79, back: 7 },
      { icon: '🔌', name: 'Universal travel adapter', why: 'Different plugs abroad', price: 23, back: 5 },
    ],
...
const STANDALONE = {
  ...
  budget: 1200, tower: '🏙️', airports: 'ORD', welcome: 'Welcome to Chicago 🌆 — no plan, no problem',
